...
其中 $R_j$ 互不相交, $1_{R_j}(x)$ 为示性函数, 当 $x\in R_j$ 时为 1 否则为 0, $w_j$ 为常数, 参数 $\Theta=\\{(R_j,w_j)\\}_{j=1}^T$, $T$ 为叶节点个数.
...
![来自原论文](https://shiina18.github.io/assets/posts/https://img2018.cnblogs.com/blog/1589130/201906/1589130-20190616184746391-931870527.png "来自原论文")
...
- [5] Kodi Arfer. (2018). [XGBoost, missing values, and sparsity](http://arfer.net/w/xgboost-sparsity).
- [6] [1.11. Ensemble methods — scikit-learn 0.23.2 documentation](https://scikit-learn.org/stable/modules/ensemble.html#gradient-tree-boosting)